...
"""
from ContactPose.utilities import init_paths
from ContactPose.utilities.import_open3d import *  # need to import open3d before others
import json
from matplotlib import cm
import numpy as np
import os
from random import shuffle
from ContactPose.utilities.dataset import get_p_nums
...
def discover_active_areas(finger_idx, part_idx, object_name, intent, p_nums=None,
  ...
  data_dir = osp.join('/home/dataset/haoming/ContactPose','data', 'contactpose_data')
  ...
  filename = osp.join('/home/dataset/haoming/ContactPose','data',
...
if __name__ == '__main__':
  ...
  parser.add_argument('--finger_idx', default=0, type=int,
                      help='0->4 : thumb->little', choices=(0, 1, 2, 3, 4))
  parser.add_argument('--part_idx', type=int, default=0, choices=(0, 1, 2, 3),
                      help='0->3 : proximal to distal phalanges, 3 = finger tip')
  parser.add_argument('--object_name',default='apple', type=str)
  parser.add_argument('--intent', default='use', type=str, choices=('use', 'handoff'))
  parser.add_argument('--p_nums', default='1-2',
