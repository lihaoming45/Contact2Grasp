...
if __name__ == '__main__':
  import sys
  parser = mutils.default_argparse(p_num=45, intent='use', object_name='hammer')
  parser.add_argument('--mode', help='Contact Map mode', default='simple_mano',
