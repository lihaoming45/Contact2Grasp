...
def create_contact_pose_dataset_args():
    parser = argparse.ArgumentParser(description='creat_cp_dataset')
    parser.add_argument('--data_path', default="I:\ContactPose\data\contactpose_data", type=str)
