...
def name_to_verts(obj_name):

    obj_verts_dict = {'mouse': 100597, 'binoculars': 29537, 'bowl': 100150, 'camera': 120611, 'cell_phone': 64874, 'cup': 177582,
     'eyeglasses': 22316, 'flashlight': 46334, 'hammer': 35949, 'headphones': 93324, 'knife': 19962, 'mug': 169964,
     'pan': 57938, 'ps_controller': 95822, 'scissors': 57824, 'stapler': 144605, 'toothbrush': 19708,
     'toothpaste': 42394, 'utah_teapot': 126627, 'water_bottle': 90926, 'wine_glass': 104201, 'door_knob': 108248,
     'light_bulb': 71188, 'banana': 42232, 'apple': 93361, 'HO_sugar': 8300, 'HO_soap': 8251, 'HO_mug': 16763, 'train': 148245,
     'HO_mustard': 10983, 'HO_drill': 9174, 'HO_cheezits': 8291, 'HO_spam': 8342, 'HO_banana': 10710,
     'HO_scissors': 8628, 'train_exclude': 148245}

    if obj_name in obj_verts_dict:
        return obj_verts_dict[obj_name]
    return 'DIDNT FIND {}'.format(obj_name)


def fixed_sample_idx(obj_names):

    fixed_sample_idx_dict = {}
    for obj_name in obj_names:
        obj_num_verts = name_to_verts(obj_name)
        # fixed_sample_idx_dict[obj_name]=np.random.randint(0, obj_num_verts, SAMPLE_VERTS_NUM)
        fixed_sample_idx_dict[obj_name] = np.random.choice(obj_num_verts, SAMPLE_VERTS_NUM, replace=False)

    return fixed_sample_idx_dict


def name_to_class(obj_name):

    obj_names_dict={'apple': 0, 'banana': 1, 'binoculars': 2, 'bowl': 3, 'camera': 4, 'cell_phone': 5, 'cup': 6,
                    'eyeglasses': 7, 'flashlight': 8, 'hammer': 9, 'headphones': 10, 'knife': 11, 'light_bulb': 12,
                    'mouse': 13, 'mug': 14, 'pan': 15, 'ps_controller': 16, 'scissors': 17, 'stapler': 18,
                    'toothbrush': 19, 'toothpaste': 20, 'utah_teapot': 21,'water_bottle': 22,
                    'wine_glass': 23, 'door_knob': 24, 'palm_print': 25, 'train': 26}

    return obj_names_dict[obj_name]
...
def get_mano_closed_faces(mano_root=osp.join('.', 'manopth', 'mano', 'models')):
